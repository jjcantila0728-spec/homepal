// Static lookup tables, theme maps, and procedural SVG artwork.
// Pure data — no DOM, no state, no imports. The leaf of the module graph.

export const catColors = { family: '#10B981', school: '#3B82F6', work: '#F59E0B', health: '#EF4444', social: '#8B5CF6', education: '#EC4899' };
export const statusIcons = { home: 'fa-house', school: 'fa-school', out: 'fa-car', work: 'fa-briefcase', gym: 'fa-dumbbell' };
...
export const devTypeColors = { lock: '#EF4444', camera: '#3B82F6', sensor: '#06B6D4', media: '#8B5CF6', appliance: '#10B981', climate: '#F59E0B' };
export const dayNames = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];

export const debtMeta = {
...
/* ===== Generated SVG artwork (procedural, offline, theme-aware, crisp at any DPI) ===== */
export const ART = {
  home: function () {
    var rays = ''; for (var i = 0; i < 12; i++) { var a = i * 30 * Math.PI / 180, x1 = 356 + Math.cos(a) * 30, y1 = 78 + Math.sin(a) * 30, x2 = 356 + Math.cos(a) * 41, y2 = 78 + Math.sin(a) * 41; rays += '<line x1="' + x1.toFixed(1) + '" y1="' + y1.toFixed(1) + '" x2="' + x2.toFixed(1) + '" y2="' + y2.toFixed(1) + '" stroke="#F59E0B" stroke-width="3" stroke-linecap="round" opacity=".7"/>'; }
